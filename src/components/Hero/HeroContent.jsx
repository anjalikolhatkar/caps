  ...
  return (
    <div className='bg-accent w-5/6 hero-content flex flex-col gap-7 max-w-2xl py-14 px-7 text-center'>
      ...
      <div className='flex gap-2 uppercase'>
        <a href='#service' className='bg-secondary text-primary px-3 py-1'>Learn More</a>
        <a href="#library-service-form" className='border border-secondary text-secondary px-3 py-1'>
          Book Now
        </a>
      </div>
    </div>
